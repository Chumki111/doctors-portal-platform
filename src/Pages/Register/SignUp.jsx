                ...
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl border shadow-md font-sans">
                    ...
                    <form onSubmit={handleRegister} action="" className="space-y-6">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            {/* image input */}
                            <input type="file" name="image" id="image" placeholder="Password" className=" px-4 py-3 rounded-md border   dark:border-[#19D3AE]  focus:dark:border-[#19D3AE] appearance-none block w-full text-sm text-slate-500 
      file:mr-4 file:py-2 file:px-4
      file:rounded-full file:border-0
      file:text-sm file:font-semibold
      file:bg-violet-50 file:text-[#19D3AE]
